...
<html>
	<head>
	<title>GERENCIADOR DE POSTS | CANAÃ JARDIM GUANABARA</title>
		<meta charset="utf-8" />
						...
						<!-- Post -->
							<section class="post">
								<header class="major">
									...
									<h3>ADMINISTRAÇÃO - GERENCIAR POSTAGENS</h3>
									<a href="actions" class="button small"><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;&nbsp;&nbsp;VOLTAR</a>
									<a href="createpost" class="button small"><i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;&nbsp;NOVA POSTAGEM</a>
									...
									<table class="alt">
										<thead>
											<tr>
												...
												<th>Autor</th>
												<th><center>EDITAR | EXCLUIR</center></th>
											</tr>
										</thead>
										<tbody id="table-data">
			...
			<script type="text/javascript">
				...
				if(!isNaN(parseInt(id, 10))){
					...
					$("#pesquisa").keyup(function(){
						...
						limit = 10;
						$.ajax({
							url: 'assets/php/infintyScroll_liveSearch_adm',
							method: 'post',
